...
$SASCredential = Get-DbaCredential -SqlInstance $sourceInstance


if ($SASCredential.Name -like "*$blobStorageAccount*")
{
...
$target = Connect-DbaInstance -SqlInstance $targetInstance -SqlCredential $target_login

#Get-DbaCredential -SqlInstance $targetInstance -SqlCredential $target_login


#checking if credential already exist or need be created
$SASCredential = Get-DbaCredential -SqlInstance $targetInstance -SqlCredential $target_login
